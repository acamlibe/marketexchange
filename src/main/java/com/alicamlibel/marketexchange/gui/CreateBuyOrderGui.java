...
public class CreateBuyOrderGui extends Gui {
    public static final int BUY_ORDER_INVENTORY_INDEX = 4;
    public static final int BUY_ITEM_INVENTORY_INDEX = 13;
    ...
    public CreateBuyOrderGui(Material material, int pricePerQuantity, int quantity, double feePercent) {
    ...
    private void initGui() {
        ...
        setItem(3, Material.RED_CANDLE, "§cCancel Buy Order");
        setBuyOrderItem(BUY_ORDER_INVENTORY_INDEX);

        setItem(5, Material.GREEN_CANDLE, "§aConfirm Buy Order");

        setItem(BUY_ITEM_INVENTORY_INDEX, material, "", "Buy Order Item");
    ...
    private void setBuyOrderItem(int inventoryIndex) {
        ...
        setItem(inventoryIndex, Material.PAPER, "§3Buy Order",
